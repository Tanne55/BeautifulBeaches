                ...
                @forelse ($tours as $tour)
                    <div class="card m-4">
                        <div class="card-image"
                            ...
                            <div class="price-tag">{{ number_format($tour['current_price'], 0, ',', '.') }}TR VNĐ <span>/ mỗi
                                    người</span></div>
                            <div class="card-meta">
                ...
                <div class="col-md-4">
                    <div class="text-center p-3">
                        <div class="bg-light rounded p-4 mb-3 shadow-lg">
                            ...
                            <p class="text-muted mb-3">15-17 Tháng 11</p>
                ...
                <div class="col-md-4">
                    <div class="text-center p-3">
                        <div class="bg-light rounded p-4 mb-3 shadow-lg">
                            ...
                            <p class="text-muted mb-3">Giảm đến 90%</p>
                            <p class="text-muted small">
                                Đặt tour và dịch vụ trong tháng 11 để nhận ưu đãi đặc biệt
