...
<div class="container-fluid py-3" style="padding-left: 100px;">
    <div class="row">
        <div class="col-12">
            ...
            <a href="{{ route('ceo.tickets.index', ['open_booking' => $ticket->tour_booking_id]) }}" class="btn btn-outline-secondary btn-sm mb-3">
                ...
                <div class="col-md-6">
                    <div class="border rounded p-3 h-100">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li><strong>Code:</strong> <span class="badge bg-secondary fs-6">{{ $ticket->ticket_code }}</span></li>
                            <li><strong>Status:</strong>
                                @if($ticket->status === 'valid')
                                    <span class="badge bg-success"><i class="fas fa-check-circle me-1"></i>Valid</span>
                                @elseif($ticket->status === 'used')
                                    <span class="badge bg-warning text-dark"><i class="fas fa-user-check me-1"></i>Used</span>
                                @else
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="border rounded p-3">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li><strong>Title:</strong> <span class="text-primary">{{ $ticket->tourBooking->tour->title }}</span></li>
                            <li><strong>Price:</strong> ₫{{ number_format($ticket->tourBooking->tour->price ?? 0) }}</li>
                ...
                <div class="col-12 d-flex flex-wrap gap-2">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" onclick="updateStatus('valid')"><i class="fas fa-check text-success me-1"></i>Mark as Valid</a></li>
                            <li><a class="dropdown-item" href="#" onclick="updateStatus('used')"><i class="fas fa-user-check text-warning me-1"></i>Mark as Used</a></li>
                            <li><a class="dropdown-item" href="#" onclick="updateStatus('cancelled')"><i class="fas fa-times text-danger me-1"></i>Mark as Cancelled</a></li>
                        </ul>
                    </div>
