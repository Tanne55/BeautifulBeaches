...
@section('content')
  ...
  @foreach($bookings as $booking)
    ...
    <h5 class="offcanvas-title" id="ticketsOffcanvasLabel{{ $booking->id }}">Danh sách vé của booking
      #{{ $booking->id }}</h5>
    ...
    <table class="table table-sm table-bordered align-middle">
      ...
      <li>
        ...
        <button type="submit" class="dropdown-item"><i class="fas fa-check text-success me-1"></i>Mark as
        Valid</button>
        </form>
      </li>
      <li>
        ...
        <button type="submit" class="dropdown-item"><i class="fas fa-user-check text-warning me-1"></i>Mark
        as Used</button>
        </form>
      </li>
      <li>
        ...
        <button type="submit" class="dropdown-item"><i class="fas fa-times text-danger me-1"></i>Mark as
        Cancelled</button>
        </form>
      </li>
      </ul>
      ...
      onclick="return confirm('Are you sure you want to delete this ticket?')" title="Delete">
