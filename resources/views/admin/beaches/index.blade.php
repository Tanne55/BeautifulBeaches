        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('admin.beaches.create') }}" class="btn btn-primary btn-lg shadow">
            ...
            <div class="card-body p-4">
                <form method="GET" action="{{ route('admin.beaches.index') }}" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select border-0 shadow-sm" name="region"
                                style="background: #f8f9fa;">
                        ...
                        @foreach($beaches as $beach)
                            <tr class="align-middle">
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <img src="{{ $imageUrl }}" alt="{{ $beach->title }}" 
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-sm" 
                                                onclick="confirmDelete({{ $beach->id }}, '{{ $beach->title }}')" 
                                                title="Xóa">
