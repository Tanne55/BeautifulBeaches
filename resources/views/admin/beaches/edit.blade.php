            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-body p-2">
                        ...
                        @endif
                        <form action="{{ route('admin.beaches.update', $beach->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <!-- Ảnh preview -->
                            <div class="mb-4 text-center">
                                <div id="drop-area" class="p-4 mb-3 border border-2 border-primary border-dashed rounded bg-light position-relative" style="cursor:pointer;">
                                    <img id="imagePreview" src="{{ old('image') ? asset('assets/image/' . old('image')) : ($beach->image ? asset($beach->image) : 'https://via.placeholder.com/900x350?text=Preview+Image') }}" alt="Preview" class="img-fluid rounded mb-2" style="max-height:350px;object-fit:cover;">
                            ...
                            <!-- Khu vực -->
                            <div class="mb-3">
                                <input type="text" class="form-control" id="region" name="region" placeholder="Khu vực (ví dụ: Quảng Ninh, Đà Nẵng...)" required value="{{ old('region', $beach->region) }}">
                            </div>
                            <!-- Mô tả ngắn -->
                            <div class="mb-3">
                            ...
                            <!-- Tags -->
                            <div class="mb-4">
                                <input type="text" class="form-control" id="tags" name="tags" value="{{ old('tags', implode(', ', $beach->tags)) }}" placeholder='Tags (ví dụ: ["Travel","Beach","Quang Ninh","Vietnam","Family"])'>
