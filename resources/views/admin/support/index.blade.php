                                    ...
                                    @forelse($supportRequests as $request)
                                                                <tr>
                                                                    <td class="text-center align-middle">
                                                                        {{ $request->name ?? $request->user->name ?? 'Anonymous' }}</td>
                                        ...
                                        <div class="status-dropdown-container" style="position: relative;">
                                            <button type="button" class="btn btn-sm btn-outline-primary status-trigger" data-request-id="{{ $request->id }}">
                                            ...
                                            <div class="status-dropdown-menu" style="display: none;">
                                                ...
                                                <a class="dropdown-item status-in-progress" href="#" data-status="in_progress">
                                                    <i class="fa fa-spinner"></i> Mark as In Progress
                                                </a>
                                                <a class="dropdown-item status-resolved" href="#" data-status="resolved">
                                                    <i class="fa fa-check-circle"></i> Mark as Resolved
                                                </a>
                                                <a class="dropdown-item status-rejected" href="#" data-status="rejected">
