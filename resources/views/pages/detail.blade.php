        ...
        <div class="row">
            <div class="content-section col-lg-7 p-5">
                ...
                <div class="position-relative mb-4">
                    ...
                    @else
                        <img src="/assets/img/default.jpg" class="img-fluid rounded shadow primary-image"
                            alt="{{ $beach->title }}" style="height: 300px; width: 100%; object-fit: cover;">
                    @endif
            ...
            <div class="col-lg-5 px-5">
                ...
                <div class="author-card mb-4">
                    <div class="text-center">
                        ...
                        <img src="{{asset('assets/img1/img_author.jpg')}}" alt="..." class="author-avatar mb-3">
                        <h5>DUY TÂN</h5>
                        <p class="text-muted small">
                            TÂN là một nhà văn du lịch và người đam mê biển, đã khám phá hơn 50 điểm đến ven biển khắp Đông
                            Nam Á.
                            Với niềm đam mê kể chuyện và nhiếp ảnh, anh chia sẻ những “viên ngọc ẩn”, góc nhìn văn hóa và
                            mẹo du lịch thực tế để giúp mọi người lên kế hoạch cho những chuyến phiêu lưu bên bờ biển khó
                            quên!
                        </p>
                ...
                <div class="bg-white p-3 rounded shadow-sm mb-4">
                    ...
                    @forelse($relatedTours as $tour)
                        <div class="recent-post-item {{ $loop->last ? 'border-0' : '' }}">
                            ...
                            @if($img)
                                <img src="{{ $isAsset ? $img : asset('storage/' . $img) }}" alt="{{ $tour->title }}"
                                    class="recent-post-img">
                            @elseif($beachImg)
                                <img src="{{ $isBeachAsset ? $beachImg : asset('storage/' . $beachImg) }}" alt="{{ $tour->title }}"
                                    class="recent-post-img">
                            @else
                                <img src="https://via.placeholder.com/120x90?text=No+Image" alt="No image" class="recent-post-img">
                            @endif
