                        ...
                        @if (session('success'))
                            <div class="alert alert-success">
                                ...
                                @if(session('booking_code'))
                                    ...
                                    <p class="small mb-0"><i class="bi bi-info-circle"></i> Vui lòng lưu lại mã này để tra cứu trạng thái đặt tour.</p>
                                @endif
                            </div>
                                ...
                                <div class="card mt-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li><strong>Trạng thái:</strong> <span class="badge bg-warning text-dark">Đang chờ xác nhận</span></li>
                                            <li><strong>Bước tiếp theo:</strong> Chúng tôi sẽ liên hệ với bạn qua email hoặc điện thoại để xác nhận đặt tour.</li>
                                        </ul>
                                    </div>
                                </div>
                            @endif
                        ...
                        <form action="{{ route('tour.booking.store', $tour->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <small class="text-muted">Giá: {{ number_format($tour->prices->first()->final_price, 0, ',', '.') }} triệu đồng</small>
                                    </div>
                                </div>
                                @if($tour->detail && $tour->detail->departure_time)
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-md-6">
                                            <small class="text-muted">Trở về: {{ $tour->detail->return_time ? date('d/m/Y', strtotime($tour->detail->return_time)) : 'N/A' }}</small>
                                        </div>
                                    </div>
                                @endif
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateTotal() {
                ...
                totalAmountDiv.textContent = total.toLocaleString('vi-VN') + ' đ';
            }
