                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('tour.booking.store', $tour->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="contact_email" id="contact_email" class="form-control" value="{{ old('contact_email', Auth::user()->email) }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="contact_phone" class="form-label">Số điện thoại</label>
                            <input type="text" name="contact_phone" id="contact_phone" class="form-control" value="{{ old('contact_phone') }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <a href="{{ route('tour.show', $tour->id) }}" class="btn btn-link w-100 mt-2">Quay lại chi tiết tour</a>
                    </form>
                </div>
            </div>
        </div>
