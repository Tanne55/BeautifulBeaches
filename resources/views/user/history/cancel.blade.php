                ...
                <div class="card-body">
                    <form action="{{ route('user.booking.cancel.submit', $booking->id) }}" method="POST">
                        ...
                        <div class="mb-3" id="partial-slots" style="display:none;">
                            ...
                            <input type="number" name="cancelled_slots" class="form-control" min="1" max="{{ $booking->number_of_people }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <a href="{{ route('user.history') }}" class="btn btn-link w-100 mt-2">Quay lại lịch sử đặt tour</a>
                    </form>
                </div>
            </div>
        </div>
